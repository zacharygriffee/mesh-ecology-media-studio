...
lane after package rework is requested or after a reviewed package becomes
stale against rough-cut/output refs; it keeps the same non-authority posture as
