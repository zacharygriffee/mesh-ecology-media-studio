...
| `npm run production:authority-prereqs` | yes | yes | `--print` | yes | writes local package prerequisite posture and future authority gaps without adding authority |
| `npm run production:authority-handoff` | yes | yes | `--print` | yes | packages bundle/proposal/capsule/situated/export delivery refs as a candidate for future authority review; does not grant authority |
