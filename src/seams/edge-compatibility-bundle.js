...
export async function writeEdgeCompatibilityBundle({
  ...
  if (print) {
    ...
    console.log([
      ...
      `activeDelivery=${bundle.exportDeliverySummary.activeDeliveryReceipts}`,
      ...
      `spineDurableAppend=${bundle.adjacentSeamReadiness.durableAppend === true}`,
      `spineEdgeQueueAction=${bundle.adjacentSeamReadiness.edgeQueueAction === true}`,
      ...
      `currentOperationFamilyAsks=${bundle.currentOperationSummary.familyAsks}`,
      `currentOperationFamilyAsksReady=${bundle.currentOperationSummary.familyAsksReady}`,
...
function createExportDeliverySummary({ sources }) {
  ...
  return {
    ...
    currentAttentionRows: exportReceiptSummary.currentAttentionRows.map(edgeExportReceiptRow),
    historicalAttentionRows: exportReceiptSummary.historicalAttentionRows.map(edgeExportReceiptRow),
    currentAttention: exportReceiptSummary.currentAttention,
    historicalAttention: exportReceiptSummary.historicalAttention,
