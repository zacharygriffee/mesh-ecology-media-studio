...
export function formatPublicationAuthorityRequestCandidateSummary(candidate, output = defaultOutput) {
  return [
    ...
    `activeDeliveryReceipts=${candidate.prerequisiteSummary.activeDeliveryReceipts}`,
    `currentExportReceiptAttention=${candidate.prerequisiteSummary.currentExportReceiptAttention}`,
    `historicalExportReceiptAttention=${candidate.prerequisiteSummary.historicalExportReceiptAttention}`,
